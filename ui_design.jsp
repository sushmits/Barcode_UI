<%-- 
    Document   : ui_design
    Created on : May 29, 2018, 4:13:21 PM
    Author     : sushm
--%>
...
<html>
    ...
    <body>
        ...
        <div class="image">
            ...
            <br>
            <img id="img_graph" style="margin:20px;" alt="second0.gif" src="<%= request.getAttribute("fig_link")%>" >
            <br>
            <a href="<%=request.getAttribute("csv") %>" style="float:right; padding-right: 10px;font-size: 20px;">Barcodes_csv_download</a>
            <br>
            <br>
            <a href = "<%=request.getAttribute("dist") %>" style="float:right; padding-right: 10px;font-size: 20px;" onclick="onclickDistanceMatrix()">Distance Matrix </a>
            <br>
            <br>
            <br>
            <%= request.getAttribute("table_html")%>
           
        </div>
            <%}else{%> <div class="image">An error occured. Please try again</div><%}%>

        <form action="BarcodeCaddyServlet" method="GET" >
            <div style="width:30%;">           
